...
const API_ROOT = 'https://7jde2hlm78.execute-api.us-east-2.amazonaws.com'; // CHANGE THIS TO MATCH THE URL OF YOUR API GATEWAY API OR YOUR CUSTOM DOMAIN FOR API
